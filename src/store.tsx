...
export const store = {
    ...
    addPosts() {
        const post = {id: 3, message: state.profilePage.newPostText, like: 0};
        this._state.profilePage.posts.push(post);
        this._state.profilePage.newPostText = ""
        this.onChange(state)
    },
    updateNewPostText(changeValue: string) {
        this._state.profilePage.newPostText = changeValue
        this.onChange(state)
    },
    onChange(state: StateType) {
